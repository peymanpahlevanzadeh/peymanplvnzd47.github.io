...
author: "Peyman Pahlevanzadeh"
description: "Here I will share some of my own thoughts about science, and books which I had read." # This will show up in places like twitter, linkedin, etc, if you share your sites url as a post.

 Email / Social media user names used by the minima theme:
# All of these are optional and can be removed or commented out
email: "peymanplvnzd@gmail.com"
